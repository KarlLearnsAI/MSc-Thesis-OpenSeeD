...
def main(args=None):
    ...
    thing_colors = [random_color(rgb=True, maximum=1).tolist() for _ in range(len(thing_classes))]
    stuff_colors = [random_color(rgb=True, maximum=1).tolist() for _ in range(len(stuff_classes))]
